$(function() {
  var $DataTableEl, $TouchSpinEl, $asColorPickerEl, $counterUpEl, $datepickerEl, $daterangepickerEl, $easyPieChartEl, $labelautyEl, $maxlengthEl, $multiselectEl, $peityBarEl, $peityDonutEl, $peityLineEl, $peityPieEl, $select2El, $selectpickerEl, $sssEl, $submenupickerEl, $summernoteEl, $timepickerEl, gridMasonry;
